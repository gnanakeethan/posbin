...
INSERT INTO `bills` VALUES (2,0.0000,0.0000,0.0000,0.0000,0.0000,0.0000,0.0000,0,'2017-08-08 05:30:45','2017-08-08 05:30:45',NULL,NULL,1,1,1);
...
INSERT INTO `migrations` VALUES (1,'Stores_20170713_201929','2017-08-07 23:51:04','CREATE TABLE `stores` (\n `id` INT(10) UNSIGNED NOT NULL auto_increment ,\n `store_name` VARCHAR(255)  NOT NULL  ,\n `address` text    DEFAULT NULL,\n `contact` tinytext    DEFAULT NULL,\n PRIMARY KEY(  `id`),\n UNIQUE KEY `name_unique`(  `store_name`))ENGINE=InnoDB DEFAULT CHARSET=utf8;',NULL,'update'),(2,'Discounts_20170713_201954','2017-08-07 23:51:04','CREATE TABLE `discounts` (\n `id` INT(10) UNSIGNED NOT NULL auto_increment ,\n `name` VARCHAR(255) COLLATE utf8_unicode_ci  NOT NULL  ,\n `from` datetime  NOT NULL  ,\n `to` datetime  NOT NULL  ,\n `type` enum(\'value\',\'percentage\') COLLATE utf8_unicode_ci  NOT NULL  ,\n `value` DOUBLE(8,2)  NOT NULL  ,\n PRIMARY KEY(  `id`),\n `store_id` int(10) UNSIGNED   DEFAULT NULL,\n KEY  `discounts_store_id_foreign`(`store_id`),\n CONSTRAINT `discounts_store_id_foreign` FOREIGN KEY (`store_id`) REFERENCES `stores` (`id`)   )ENGINE=InnoDB DEFAULT CHARSET=utf8;',NULL,'update'),(3,'Users_20170716_065940','2017-08-07 23:51:04','CREATE TABLE `users` (\n `id` INT(10) UNSIGNED NOT NULL auto_increment ,\n `username` VARCHAR(255)    DEFAULT NULL,\n `email` VARCHAR(255)    DEFAULT NULL,\n `password` VARCHAR(255)    DEFAULT NULL,\n `remember_token` VARCHAR(255)    DEFAULT NULL,\n `created_at` DATETIME    DEFAULT NULL,\n `updated_at` DATETIME    DEFAULT NULL,\n PRIMARY KEY(  `id`),\n UNIQUE KEY `username`(  `username`))ENGINE=InnoDB DEFAULT CHARSET=utf8;',NULL,'update'),(4,'Roles_20170716_071411','2017-08-07 23:51:04','CREATE TABLE `roles` (\n `id` INT(10) UNSIGNED NOT NULL auto_increment ,\n `name` VARCHAR(255)  NOT NULL  ,\n `display_name` VARCHAR(255)    ,\n `description` VARCHAR(255)    ,\n `created_at` DATETIME    DEFAULT NULL,\n `updated_at` DATETIME    DEFAULT NULL,\n PRIMARY KEY(  `id`))ENGINE=InnoDB DEFAULT CHARSET=utf8;',NULL,'update'),(5,'Permissions_20170716_083154','2017-08-07 23:51:04','CREATE TABLE `permissions` (\n `id` INT(10) UNSIGNED NOT NULL auto_increment ,\n `name` VARCHAR(255)  NOT NULL  ,\n `display_name` VARCHAR(255)    ,\n `description` VARCHAR(255)    ,\n `created_at` DATETIME    DEFAULT NULL,\n `updated_at` DATETIME    DEFAULT NULL,\n PRIMARY KEY(  `id`))ENGINE=InnoDB DEFAULT CHARSET=utf8;',NULL,'update'),(6,'PermissionRole_20170716_083244','2017-08-07 23:51:04','CREATE TABLE `permission_role` (\n `id` INT(10) UNSIGNED NOT NULL auto_increment ,\n PRIMARY KEY(  `id`),\n UNIQUE KEY `role_permission`(  `role_id`, `permission_id`),\n `role_id` INT(10) UNSIGNED   ,\n KEY  `permission_role_role_id_foreign`(`role_id`),\n CONSTRAINT `permission_role_role_id_foreign` FOREIGN KEY (`role_id`) REFERENCES `roles` (`id`)   ,\n `permission_id` INT(10) UNSIGNED   ,\n KEY  `permission_role_permission_id_foreign`(`permission_id`),\n CONSTRAINT `permission_role_permission_id_foreign` FOREIGN KEY (`permission_id`) REFERENCES `permissions` (`id`)   )ENGINE=InnoDB DEFAULT CHARSET=utf8;',NULL,'update'),(7,'RoleUser_20170716_084548','2017-08-07 23:51:04','CREATE TABLE `role_user` (\n `id` INT(10) UNSIGNED NOT NULL auto_increment ,\n PRIMARY KEY(  `id`),\n UNIQUE KEY `role_user`(  `role_id`, `user_id`),\n `role_id` INT(10) UNSIGNED   ,\n KEY  `role_user_role_id_foreign`(`role_id`),\n CONSTRAINT `role_user_role_id_foreign` FOREIGN KEY (`role_id`) REFERENCES `roles` (`id`)   ,\n `user_id` INT(10) UNSIGNED   ,\n KEY  `role_user_user_id_foreign`(`user_id`),\n CONSTRAINT `role_user_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`)   )ENGINE=InnoDB DEFAULT CHARSET=utf8;',NULL,'update'),(8,'Scales_20170716_084718','2017-08-07 23:51:04','CREATE TABLE `scales` (\n `id` INT(10) UNSIGNED NOT NULL auto_increment ,\n `description` VARCHAR(255)    ,\n `unit` VARCHAR(10)    ,\n `created_at` DATETIME    DEFAULT NULL,\n `updated_at` DATETIME    DEFAULT NULL,\n PRIMARY KEY(  `id`),\n `store_id` int(10) UNSIGNED   DEFAULT NULL,\n KEY  `scales_store_id_foreign`(`store_id`),\n CONSTRAINT `scales_store_id_foreign` FOREIGN KEY (`store_id`) REFERENCES `stores` (`id`)   )ENGINE=InnoDB DEFAULT CHARSET=utf8;',NULL,'update'),(9,'Products_20170716_085355','2017-08-07 23:51:04','CREATE TABLE `products` (\n `id` INT(10) UNSIGNED NOT NULL auto_increment ,\n `product_code` VARCHAR(255)  NOT NULL  ,\n `barcode` VARCHAR(255)    ,\n `name` VARCHAR(255)  NOT NULL  ,\n `singular` tinyint(1)    DEFAULT NULL,\n `priority` tinyint(1)    DEFAULT NULL,\n `ordering` int(10) UNSIGNED NOT NULL  ,\n `image` BLOB    DEFAULT NULL,\n `image_type` VARCHAR(20)    DEFAULT NULL,\n `service` TINYINT(1)  NOT NULL  DEFAULT 0,\n `created_at` DATETIME    DEFAULT NULL,\n `updated_at` DATETIME    DEFAULT NULL,\n PRIMARY KEY(  `id`),\n `scale_id` INT(10) UNSIGNED   DEFAULT NULL,\n KEY  `products_scale_id_foreign`(`scale_id`),\n CONSTRAINT `products_scale_id_foreign` FOREIGN KEY (`scale_id`) REFERENCES `scales` (`id`)   )ENGINE=InnoDB DEFAULT CHARSET=utf8;',NULL,'update'),(10,'StoreUser_20170716_090051','2017-08-07 23:51:04','CREATE TABLE `store_user` (\n `id` INT(10) UNSIGNED NOT NULL auto_increment ,\n PRIMARY KEY(  `id`),\n UNIQUE KEY `store_user`(  `stores_id`, `users_id`),\n `stores_id` INT(10) UNSIGNED   ,\n KEY  `store_user_stores_id_foreign`(`stores_id`),\n CONSTRAINT `store_user_stores_id_foreign` FOREIGN KEY (`stores_id`) REFERENCES `stores` (`id`)   ,\n `users_id` INT(10) UNSIGNED   ,\n KEY  `store_user_users_id_foreign`(`users_id`),\n CONSTRAINT `store_user_users_id_foreign` FOREIGN KEY (`users_id`) REFERENCES `users` (`id`)   )ENGINE=InnoDB DEFAULT CHARSET=utf8;',NULL,'update'),(11,'Discountables_20170716_090213','2017-08-07 23:51:04','CREATE TABLE `discountables` (\n `id` INT(10) UNSIGNED NOT NULL auto_increment ,\n `discountable_id` INT(10) UNSIGNED   DEFAULT NULL,\n `discountable_type` VARCHAR(255)  NOT NULL  ,\n `created_at` DATETIME    DEFAULT NULL,\n `updated_at` DATETIME    DEFAULT NULL,\n PRIMARY KEY(  `id`),\n `discount_id` INT(10) UNSIGNED   DEFAULT NULL,\n KEY  `discountables_discount_id_foreign`(`discount_id`),\n CONSTRAINT `discountables_discount_id_foreign` FOREIGN KEY (`discount_id`) REFERENCES `discounts` (`id`)   )ENGINE=InnoDB DEFAULT CHARSET=utf8;',NULL,'update'),(12,'ProductProduct_20170716_090500','2017-08-07 23:51:04','CREATE TABLE `product_product` (\n `id` INT(10) UNSIGNED NOT NULL auto_increment ,\n `units` DOUBLE(8,2)  NOT NULL  DEFAULT 1,\n `created_at` DATETIME    DEFAULT NULL,\n `updated_at` DATETIME    DEFAULT NULL,\n PRIMARY KEY(  `id`),\n UNIQUE KEY `parent_child`(  `parent_id`, `child_id`),\n `parent_id` INT(10) UNSIGNED   DEFAULT NULL,\n KEY  `product_product_parent_id_foreign`(`parent_id`),\n CONSTRAINT `product_product_parent_id_foreign` FOREIGN KEY (`parent_id`) REFERENCES `products` (`id`)   ,\n `child_id` INT(10) UNSIGNED   DEFAULT NULL,\n KEY  `product_product_child_id_foreign`(`child_id`),\n CONSTRAINT `product_product_child_id_foreign` FOREIGN KEY (`child_id`) REFERENCES `products` (`id`)   )ENGINE=InnoDB DEFAULT CHARSET=utf8;',NULL,'update'),(13,'Inventories_20170716_090814','2017-08-07 23:51:04','CREATE TABLE `inventories` (\n `id` INT(10) UNSIGNED NOT NULL auto_increment ,\n `batch_no` VARCHAR(255)  NOT NULL  ,\n `created_at` DATETIME    DEFAULT NULL,\n `updated_at` DATETIME    DEFAULT NULL,\n `service` TINYINT(1)  NOT NULL  DEFAULT 0,\n PRIMARY KEY(  `id`),\n `product_id` INT(10) UNSIGNED   DEFAULT NULL,\n KEY  `inventories_product_id_foreign`(`product_id`),\n CONSTRAINT `inventories_product_id_foreign` FOREIGN KEY (`product_id`) REFERENCES `products` (`id`)   )ENGINE=InnoDB DEFAULT CHARSET=utf8;',NULL,'update'),(14,'Stocks_20170716_090934','2017-08-07 23:51:04','CREATE TABLE `stocks` (\n `id` INT(10) UNSIGNED NOT NULL auto_increment ,\n `available_stock` DOUBLE(8,2)  NOT NULL  DEFAULT 1,\n PRIMARY KEY(  `id`),\n `inventory_id` INT(10) UNSIGNED   DEFAULT NULL,\n KEY  `stocks_inventory_id_foreign`(`inventory_id`),\n CONSTRAINT `stocks_inventory_id_foreign` FOREIGN KEY (`inventory_id`) REFERENCES `inventories` (`id`)   )ENGINE=InnoDB DEFAULT CHARSET=utf8;',NULL,'update'),(15,'InventoryScale_20170716_091044','2017-08-07 23:51:04','CREATE TABLE `inventory_scale` (\n `id` INT(10) UNSIGNED NOT NULL auto_increment ,\n `units` DOUBLE(12,2)  NOT NULL  DEFAULT 1,\n `price` DOUBLE(12,2)  NOT NULL  DEFAULT 1,\n PRIMARY KEY(  `id`),\n `inventory_id` INT(10) UNSIGNED   DEFAULT NULL,\n KEY  `inventory_scale_inventory_id_foreign`(`inventory_id`),\n CONSTRAINT `inventory_scale_inventory_id_foreign` FOREIGN KEY (`inventory_id`) REFERENCES `inventories` (`id`)   ,\n `scale_id` INT(10) UNSIGNED   DEFAULT NULL,\n KEY  `inventory_scale_scale_id_foreign`(`scale_id`),\n CONSTRAINT `inventory_scale_scale_id_foreign` FOREIGN KEY (`scale_id`) REFERENCES `scales` (`id`)   )ENGINE=InnoDB DEFAULT CHARSET=utf8;',NULL,'update'),(16,'StockFlows_20170716_091143','2017-08-07 23:51:04','CREATE TABLE `stock_flows` (\n `id` INT(10) UNSIGNED NOT NULL auto_increment ,\n `flow` DOUBLE(4,2)  NOT NULL  DEFAULT 1,\n `stockable_id` VARCHAR(255)    DEFAULT NULL,\n `stockable_type` VARCHAR(255)    DEFAULT NULL,\n `created_at` DATETIME    DEFAULT NULL,\n `updated_at` DATETIME    DEFAULT NULL,\n PRIMARY KEY(  `id`),\n `inventory_id` INT(10) UNSIGNED   DEFAULT NULL,\n KEY  `stock_flows_inventory_id_foreign`(`inventory_id`),\n CONSTRAINT `stock_flows_inventory_id_foreign` FOREIGN KEY (`inventory_id`) REFERENCES `inventories` (`id`)   )ENGINE=InnoDB DEFAULT CHARSET=utf8;',NULL,'update'),(17,'Purchases_20170716_091344','2017-08-07 23:51:04','CREATE TABLE `purchases` (\n `id` INT(10) UNSIGNED NOT NULL auto_increment ,\n `average_cost` DOUBLE(12,2)  NOT NULL  DEFAULT 1,\n `units` DOUBLE(12,2)  NOT NULL  DEFAULT 1,\n `created_at` DATETIME    DEFAULT NULL,\n `updated_at` DATETIME    DEFAULT NULL,\n PRIMARY KEY(  `id`),\n `inventory_id` INT(10) UNSIGNED   DEFAULT NULL,\n KEY  `purchases_inventory_id_foreign`(`inventory_id`),\n CONSTRAINT `purchases_inventory_id_foreign` FOREIGN KEY (`inventory_id`) REFERENCES `inventories` (`id`)   ,\n `stock_flow_id` INT(10) UNSIGNED   DEFAULT NULL,\n KEY  `purchases_stock_flow_id_foreign`(`stock_flow_id`),\n CONSTRAINT `purchases_stock_flow_id_foreign` FOREIGN KEY (`stock_flow_id`) REFERENCES `stock_flows` (`id`)   ,\n `store_id` INT(10) UNSIGNED   DEFAULT NULL,\n KEY  `purchases_store_id_foreign`(`store_id`),\n CONSTRAINT `purchases_store_id_foreign` FOREIGN KEY (`store_id`) REFERENCES `stores` (`id`)   )ENGINE=InnoDB DEFAULT CHARSET=utf8;',NULL,'update'),(18,'Terminals_20170716_091545','2017-08-07 23:51:04','CREATE TABLE `terminals` (\n `id` INT(10) UNSIGNED NOT NULL auto_increment ,\n `machine` VARCHAR(255)  NOT NULL  ,\n `printer` VARCHAR(255)  NOT NULL  ,\n `balance` DOUBLE(24,8)  NOT NULL  DEFAULT 1,\n `created_at` DATETIME    DEFAULT NULL,\n `updated_at` DATETIME    DEFAULT NULL,\n PRIMARY KEY(  `id`),\n `user_id` INT(10) UNSIGNED   ,\n KEY  `terminals_user_id_foreign`(`user_id`),\n CONSTRAINT `terminals_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`)   ,\n `store_id` INT(10) UNSIGNED   DEFAULT NULL,\n KEY  `terminals_store_id_foreign`(`store_id`),\n CONSTRAINT `terminals_store_id_foreign` FOREIGN KEY (`store_id`) REFERENCES `stores` (`id`)   )ENGINE=InnoDB DEFAULT CHARSET=utf8;',NULL,'update'),(19,'Tokens_20170716_091716','2017-08-07 23:51:04','CREATE TABLE `tokens` (\n `id` INT(10) UNSIGNED NOT NULL auto_increment ,\n `key` MEDIUMTEXT  NOT NULL  ,\n `valid_thru` DATETIME  NOT NULL  ,\n `valid` TINYINT(1)  NOT NULL  ,\n PRIMARY KEY(  `id`),\n `user_id` INT(10) UNSIGNED   ,\n KEY  `tokens_user_id_foreign`(`user_id`),\n CONSTRAINT `tokens_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`)   )ENGINE=InnoDB DEFAULT CHARSET=utf8;',NULL,'update'),(20,'Customers_20170716_091912','2017-08-07 23:51:04','CREATE TABLE `customers` (\n `id` INT(10) UNSIGNED NOT NULL auto_increment ,\n `name` VARCHAR(255)    ,\n `contact_no` VARCHAR(255)    ,\n `address` VARCHAR(255)    ,\n `created_at` DATETIME    DEFAULT NULL,\n `updated_at` DATETIME    DEFAULT NULL,\n PRIMARY KEY(  `id`))ENGINE=InnoDB DEFAULT CHARSET=utf8;',NULL,'update'),(21,'Bills_20170716_092032','2017-08-07 23:51:04','CREATE TABLE `bills` (\n `id` INT(10) UNSIGNED NOT NULL auto_increment ,\n `cost` DOUBLE(16,4)  NOT NULL  DEFAULT 1,\n `gross_total` DOUBLE(16,4)  NOT NULL  DEFAULT 1,\n `discount` DOUBLE(16,4)  NOT NULL  DEFAULT 1,\n `net_total` DOUBLE(16,4)  NOT NULL  DEFAULT 1,\n `balance` DOUBLE(16,4)  NOT NULL  DEFAULT 1,\n `card_paid` DOUBLE(16,4)  NOT NULL  DEFAULT 1,\n `cash_paid` DOUBLE(16,4)  NOT NULL  DEFAULT 1,\n `closed` TINYINT(1)  NOT NULL  ,\n `created_at` DATETIME    DEFAULT NULL,\n `updated_at` DATETIME    DEFAULT NULL,\n `deleted_at` DATETIME    DEFAULT NULL,\n PRIMARY KEY(  `id`),\n `customer_id` INT(10) UNSIGNED   ,\n KEY  `bills_customer_id_foreign`(`customer_id`),\n CONSTRAINT `bills_customer_id_foreign` FOREIGN KEY (`customer_id`) REFERENCES `customers` (`id`)   ,\n `user_id` INT(10) UNSIGNED   ,\n KEY  `bills_user_id_foreign`(`user_id`),\n CONSTRAINT `bills_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`)   ,\n `terminal_id` INT(10) UNSIGNED   ,\n KEY  `bills_terminal_id_foreign`(`terminal_id`),\n CONSTRAINT `bills_terminal_id_foreign` FOREIGN KEY (`terminal_id`) REFERENCES `terminals` (`id`)   ,\n `store_id` INT(10) UNSIGNED   DEFAULT NULL,\n KEY  `bills_store_id_foreign`(`store_id`),\n CONSTRAINT `bills_store_id_foreign` FOREIGN KEY (`store_id`) REFERENCES `stores` (`id`)   )ENGINE=InnoDB DEFAULT CHARSET=utf8;',NULL,'update'),(22,'Sales_20170716_092314','2017-08-07 23:51:04','CREATE TABLE `sales` (\n `id` INT(10) UNSIGNED NOT NULL auto_increment ,\n `units` DOUBLE(12,2)  NOT NULL  DEFAULT 1,\n `cost` DOUBLE(12,2)  NOT NULL  DEFAULT 1,\n `hide` TINYINT(1)  NOT NULL  ,\n `unit_price` DOUBLE(12,2)  NOT NULL  DEFAULT 1,\n `total` DOUBLE(12,2)  NOT NULL  DEFAULT 1,\n `discount` DOUBLE(12,2)  NOT NULL  DEFAULT 1,\n `amount` DOUBLE(12,2)  NOT NULL  DEFAULT 1,\n `created_at` DATETIME    DEFAULT NULL,\n `updated_at` DATETIME    DEFAULT NULL,\n `deleted_at` DATETIME    DEFAULT NULL,\n PRIMARY KEY(  `id`),\n `bill_id` INT(10) UNSIGNED   ,\n KEY  `sales_bill_id_foreign`(`bill_id`),\n CONSTRAINT `sales_bill_id_foreign` FOREIGN KEY (`bill_id`) REFERENCES `bills` (`id`)   ,\n `inventory_id` INT(10) UNSIGNED   ,\n KEY  `sales_inventory_id_foreign`(`inventory_id`),\n CONSTRAINT `sales_inventory_id_foreign` FOREIGN KEY (`inventory_id`) REFERENCES `inventories` (`id`)   )ENGINE=InnoDB DEFAULT CHARSET=utf8;',NULL,'update');
...
INSERT INTO `store_user` VALUES (1,1,1),(2,1,2);
...
INSERT INTO `terminals` VALUES (1,'POS','OSP',0.00000000,NULL,NULL,NULL,1),(2,'PSD','DSA',0.00000000,NULL,NULL,NULL,1);
...
INSERT INTO `tokens` VALUES (1,'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJVc2VySWQiOjEsImV4cCI6MTUwMjE1MDg0NSwibmJmIjoxNTAyMTUwMjQ1fQ.OKZed6bNGL2sL9jsXPtMwBA4nS1BzaN33HCqLyd6XWY','2017-08-08 05:37:25',0,1),(2,'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJVc2VySWQiOjEsImV4cCI6MTUwMjE1MDg0NiwibmJmIjoxNTAyMTUwMjQ2fQ.yHOlbRGuOJXdqggFdlNbNGOAu76XqPIh_iU0-7DE7NI','2017-08-08 05:37:26',0,1),(3,'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJVc2VySWQiOjEsImV4cCI6MTUwMjE1MDg0OCwibmJmIjoxNTAyMTUwMjQ4fQ.4FkOAlNbMXtHruoURTkTGUxIX3Os_iGriW0m57SRLSQ','2017-08-08 05:37:28',0,1),(4,'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJVc2VySWQiOjEsImV4cCI6MTUwMjE1MDg1MCwibmJmIjoxNTAyMTUwMjUwfQ.Fz3ci5POFOuaOyGxK8zgS52-1io7vIVTLxWVGph0f0s','2017-08-08 05:37:30',0,1),(5,'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJVc2VySWQiOjEsImV4cCI6MTUwMjE1MDkxMCwibmJmIjoxNTAyMTUwMzEwfQ.MS3ZquM3GKsCZNbn2y9qWDTt3DhAubafm15Jma5QuVw','2017-08-08 05:38:30',0,1),(6,'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJVc2VySWQiOjEsImV4cCI6MTUwMjE1MTA0NSwibmJmIjoxNTAyMTUwNDQ1fQ.O9TYq1TsLJWZFbkDssrf9Fa0HuiGwEeh_73j_2dOHZY','2017-08-08 05:40:45',0,1),(7,'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJVc2VySWQiOjEsImV4cCI6MTUwMjE1MTA1MywibmJmIjoxNTAyMTUwNDUzfQ.QajVjIufCf4ukhbMRr6IKw99tZi4B_IKQU4cvM8GyRo','2017-08-08 05:40:53',0,1),(8,'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJVc2VySWQiOjEsImV4cCI6MTUwMjE1MTA1MywibmJmIjoxNTAyMTUwNDUzfQ.QajVjIufCf4ukhbMRr6IKw99tZi4B_IKQU4cvM8GyRo','2017-08-08 05:40:53',0,1),(9,'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJVc2VySWQiOjEsImV4cCI6MTUwMjE1MTA2MSwibmJmIjoxNTAyMTUwNDYxfQ.uI_l1V1eXwliyi6Zu7gSdPG1JWYFtbXN3EN29umUoVM','2017-08-08 05:41:01',0,1),(10,'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJVc2VySWQiOjEsImV4cCI6MTUwMjE1MTA2MSwibmJmIjoxNTAyMTUwNDYxfQ.uI_l1V1eXwliyi6Zu7gSdPG1JWYFtbXN3EN29umUoVM','2017-08-08 05:41:01',1,1),(11,'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJVc2VySWQiOjEsImV4cCI6MTUwMjE1MTA5NiwibmJmIjoxNTAyMTUwNDk2fQ.eOguHlbmIn9wC76JoQ-45C5IuLTj0OHxMgAuNFLIL64','2017-08-08 05:41:36',0,1),(12,'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJVc2VySWQiOjEsImV4cCI6MTUwMjE1MTEwMSwibmJmIjoxNTAyMTUwNTAxfQ.tZmT40BNu9SQDFeH4IFVlesnSGmMuoQtA_fDNjwqPBQ','2017-08-08 05:41:41',0,1),(13,'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJVc2VySWQiOjEsImV4cCI6MTUwMjE1MTE2NSwibmJmIjoxNTAyMTUwNTY1fQ.aUwGLh0s2T4kUOLx-qZ9vHFyHmL5MMu6ctpPOCrYbUk','2017-08-08 05:42:45',0,1),(14,'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJVc2VySWQiOjEsImV4cCI6MTUwMjE1MTE2NywibmJmIjoxNTAyMTUwNTY3fQ.ZWib_UavkZgTZLPLfPav-zSFq_lDPvfXFwNhPohm_6Y','2017-08-08 05:42:47',1,1);
...
-- Dump completed on 2017-08-08  5:33:43
